...
export default function dealmedia() {
    return (
        <>
            <main>
                <div>
                    <section className='omos-main'>
                        <div className='omos-container relative'>
                            ...
                            <h2 className='text-overlay'>DealGuru i media</h2>
                        </div>
                    </section>

                    <section className='space-y-10 max-w-screen-md_lg mx-auto px-10 md:px-20 my-14 md:my-20'>
